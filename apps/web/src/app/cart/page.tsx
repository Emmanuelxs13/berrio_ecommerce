          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 mb-1">Envío Gratis</h3>
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-green-900 mb-1">Devoluciones Fáciles</h3>
            ...
            {items.some((item) => item.quantity > item.stock) && (
              <Alert variant="error" className="mt-6">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <strong>Stock insuficiente:</strong> Algunos productos no tienen la cantidad solicitada disponible. 
